...
public class DataFramework {
	...
	public boolean CRUDExceptionEnabled = false;
	 ...
	 *            tabla a usar
	 * @param where
	 *            parte WHERE de la consulta SQL
	 * 
	 * @return lista de objetos
	 */
	 ...
	 *            parte WHERE de la consulta SQL
	 * @param orderby
	 *            parte ORDER BY de la consulta SQL
	 * 
	 * @return lista de objetos
	 */
	 ...
	 *            parte ORDER BY de la consulta SQL
	 * @param limit
	 *            parte LIMIT de la consulta SQL
	 * 
	 * @return lista de objetos
	 */
	...
	public ArrayList<Entity> getEntityList(String table, String where, String orderby, String limit) {
		...
		c.moveToFirst();
		while (!c.isAfterLast()) {
			// Creamos la entidad a partir del cursor y nos ahorramos el acceso
			// a la BD
	 ...
	 *            array
	 * @param groupby
	 *            parte GROUP BY de la consulta SQL
	 * @param having
	 *            parte HAVING de la consulta SQL
	 * @param orderby
	 *            parte ORDER BY de la consulta SQL
	 * @param limit
	 *            parte LIMIT de la consulta SQL
	...
	public Cursor getCursor(String table, String[] fields, String selection, String[] selectionArgs, String groupby, String having,
	...
	public <E extends Entity> ArrayList<E> rawQuery(Class<E> clzz, String sql, String[] selectionArgs) {
		Cursor c = rawQuery(sql, selectionArgs);

		ArrayList<E> aux = new ArrayList<E>();
		try {
			c.moveToFirst();
			Constructor<?> constructor = clzz.getConstructor(new Class[] { Cursor.class });
			while (!c.isAfterLast()) {
				// Creamos la entidad a partir del cursor y nos ahorramos el
				// acceso a la BD
				E ent = (E) constructor.newInstance(c);
	 ...
	 * 
	 * @param file
	 *            Archivo XML donde hace la copia
	 * 
	 */
	 ...
	 *            Archivo XML donde hace la copia
	 * @param forceBackup
	 *            Forzar a hacer backup aunque la table no lo permita
	 * 
	 */
	 ...
	 * 
	 * @param file
	 *            Archivo XML donde esta la copia
	 * 
	 */
	 ...
	 * 
	 * @param void
	 * @return Boolean True si hay una transaccion en curso, false en caso
	 *         contrario.
	 */
	 ...
	 * 
	 * @param clzz
	 *            Class que extienda de entity
	 * 
	 * @return lista de objetos
	 */

	public <E extends Entity> ArrayList<E> getEntityList(Class<E> clzz) {
		return getEntityList(clzz, null, null, null);
	}
	...
	public <E extends Entity> ArrayList<E> getEntityList(Class<E> clzz, String where) {
		return getEntityList(clzz, where, null, null);
	}
	 ...
	 * 
	 * @param clzz
	 *            class de objeto que extienda de Entity
	 * @param where
	 *            parte WHERE de la consulta SQL
	 * @param orderby
	 *            parte ORDER BY de la consulta SQL
	...
	public <E extends Entity> ArrayList<E> getEntityList(Class<E> clzz, String where, String orderby) {
		return getEntityList(clzz, where, orderby, null);
	}
	...
	@SuppressWarnings("unchecked")
	public <E extends Entity> ArrayList<E> getEntityList(Class<E> clzz, String where, String orderby, String limit) {
		String table;
		ArrayList<E> aux = new ArrayList<E>();
		try {
			table = String.valueOf(clzz.getField("TABLE_NAME").get(null));
			...
			Log.e("DataFramework", "Static field TABLE_NAME or Contructor not found in " + clzz.getCanonicalName(),e);
			if(isCRUDExceptionEnabled()){
	...
	public boolean isCRUDExceptionEnabled() {
		return CRUDExceptionEnabled;
	}

	public void setCRUDExceptionEnabled(boolean cRUDExceptionEnabled) {
		CRUDExceptionEnabled = cRUDExceptionEnabled;
	}
